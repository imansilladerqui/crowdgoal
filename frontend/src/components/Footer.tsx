          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-foreground/70 text-sm">
                CrowdGoal is the world’s first decentralized crowdfunding
                platform for sports fans. Empowering fan communities to launch,
                fund, and experience the best in global sports together.
              </p>
